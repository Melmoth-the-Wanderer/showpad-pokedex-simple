...
@Component({
  ...
  templateUrl: './poke-caught-list-page.component.html',
  styleUrls: ['./poke-caught-list-page.component.scss']
})
export class PokeCaughtListPageComponent implements OnInit, OnDestroy {
